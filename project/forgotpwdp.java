...
import java.sql.*;
import java.text.*; 
public class forgotpwdp extends HttpServlet {  
...
try{
        ...
        Connection con= DriverManager.getConnection ("jdbc:oracle:thin:@localhost:1521/xe","system","sathwik123");
        String query = "update patient set pwd=? where name=?";
